...
第一颗星：where 中 name 和 class 字段能够过滤很多数据，符合一星。
第二颗星：order by 的 enname 字段在组合索引中且是索引自动排序的，符合二星。
第三颗星：select 中的 num字段、enname字段在组合索引中存在，符合三星；
...
————————————————
版权声明：本文为CSDN博主「默辨」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/qq_44377709/article/details/122076072
