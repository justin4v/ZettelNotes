...
*Many designs can be implemented using any of these three techniques*. To parameterize a sorting routine by the operation it usesto compare elements, we could make the comparison
...
3. an argument of a C++ template or Java generic that specifies the name of the function to call to compare the elements