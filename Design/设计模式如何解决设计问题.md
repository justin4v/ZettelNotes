...
2. the *responsibility of an object that's passed to the sorting program* (Strategy);
3. an argument of a C++ template or Java generic that specifies the name of the function（Method） to call to compare the elements.